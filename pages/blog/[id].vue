...
<template>
  <main v-if="post && post.publishedAt">
    ...
    <article
      class="prose prose-neutral dark:prose-invert prose-headings:font-display prose-headings:font-bold prose-h2:text-3xl/tight prose-h2:font-bold prose-h2:no-underline prose-a:hover:text-brand-gold mx-auto max-w-3xl px-4 pb-24"
    >
  ...
  <main v-else>
    ...
    <div class="flex justify-center">
      <NuxtLink
        to="/blog"
        class="bg-widget border-brand-gold hover:bg-widget-hover border-1 px-6 py-2"
        >Go Back
      </NuxtLink>
    </div>
  </main>
